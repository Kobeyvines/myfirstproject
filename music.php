...
<div class="row"style=display:flex;>
  <?php
    ...
    $sql=mysqli_query($connection,"SELECT * FROM `events` WHERE `category`='Music'")or die(mysqli_error($connection));
    while($row=mysqli_fetch_array($sql)){
  ?>
  <form method="post" action="backend/booking.php?action=add&code=<?php echo $itemArray[$key]["id"]; ?>">
  ...
  <div class="col-12 col-sm-6 col-lg-11">
      <div class="card p-3">
            <ul class="nav">
                    ...
                    <div class="container" style="width: 100%; height: 100%;">
                          ...
                          <div id="EVENT_DETAILS" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                              ...
                              <div class="modal-body" id="#EVENT_DETAILS">
                                    ...
                                    <intup type="text" value="<?php echo $row['id'];?>">
                              </div>
                                 <p id="description"></p>
              ...
              <div class="book-action"><input type="text" class="event-booking" name="quantity" value="1" size="2" />
              <input type="submit" value="Book Now" class="btnAddAction" name="booking"/></div>
